...
uint32_t __attribute__((section(".KERNEL_CODE"))) SPI_transfer(uint32_t data);
...
void __attribute__((section(".KERNEL_CODE"))) SPI_writeData(uint32_t data);
...
void __attribute__((section(".KERNEL_CODE"))) SPI_writeCmd(uint32_t cmd);
...
// de forma correcta.
void __attribute__((section(".KERNEL_CODE"))) IO_init();
...
void __attribute__((section(".KERNEL_CODE"))) SPI_writeMem(uint16_t address, uint16_t data);
uint16_t __attribute__((section(".KERNEL_CODE"))) SPI_readMem(uint16_t address);
